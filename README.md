...
## ⚪︎開発のきっかけ
JavaScriptの理解を深めるため、実践練習として作成しました。
制作にあたって、過去に友人が勉強への意識づけとしてストップウォッチアプリを活用していたことを思い出し、ヒントにしました。
このアプリは、単に時間を測るだけではなく、ユーザーの気持ちにも寄り添う存在でありたいと考えています。
ふと疲れたときや集中力が切れそうなときに、名言スライドショー「ブーストモード」を使って、モチベーションを高めたり、そっと背中を押したりできるような機能を目指しました。
<br>
